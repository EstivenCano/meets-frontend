    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={`flex flex-col z-50 absolute max-w-md items-start space-x-2 text-white p-3 rounded-md shadow-lg shadow-black/30 ${positionClasses} ${statusClasses} ${className}`}
          {...props}>
